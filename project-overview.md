# プロジェクト概要｜マルチチャネル通知システム

不動産管理会社向けの問い合わせ集約 + AI 自動分類システム（模擬案件 5・v1.0）。
背景・目的・データフロー・技術選定を全員向けに整理しています。
...
| 資料 | 内容 |
|---|---|
| `case5-test-inquiries.csv` | テスト問い合わせ 22 件（分類精度確認・境界線テスト用）・**講座提供のため Git 管理外** |
