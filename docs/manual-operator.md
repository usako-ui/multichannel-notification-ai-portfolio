# マルチチャネル通知システム 運用マニュアル（詳細版）

営業部長・現場スタッフ（非エンジニア向け）の詳しい手順書です。SQL 例・トラブル対応まで一箇所で参照できます。

📄 **現場配布用 A4 縦 1 枚版**：[`manual-operator-print.md`](./manual-operator-print.md)（日常運用に必要な最小限）
